...
import com.example.ecommerceproject.adapters.ShowAllAdapter;
...
public class ShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type !=null && type.equalsIgnoreCase("Perfumes")){
            firestore.collection("ShowAll").whereEqualTo("type","Perfumes")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type !=null && type.equalsIgnoreCase("lamp")){
            firestore.collection("ShowAll").whereEqualTo("type","lamp")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type !=null && type.equalsIgnoreCase("lights")){
            firestore.collection("ShowAll").whereEqualTo("type","lights")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type !=null && type.equalsIgnoreCase("biCycle")){
            firestore.collection("ShowAll").whereEqualTo("type","biCycle")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type !=null && type.equalsIgnoreCase("balloon")){
            firestore.collection("ShowAll").whereEqualTo("type","balloon")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
